...
public class EarthQuakeClient {
    ...
    // the method returns an arraylist of earthquakes that is greater than
    // some magnitude
    ...
    /* This method should return an ArrayList of type QuakeEntry 
     * 
     of all the earthquakes from quakeData that are 
     less than distMax from the location from.
    */
    ...
    Location from) {
        ...
        for (QuakeEntry qe : quakeData) {
            ...
            if (currentLoc.distanceTo(from) < distMax) {
                answer.add(qe);
            }
        }
    ...
    /*This method should return an ArrayList of type QuakeEntry of 
     * all the earthquakes from quakeData whose depth is 
     * between minDepth and maxDepth, exclusive. 
     */
    ...
    public void bigQuakes() {
        ...
        // get earthquakes that are greater than 5.0
        ...
        System.out.println("Found " + bigQuakes.size() + " earthquakes that match that criteria");
